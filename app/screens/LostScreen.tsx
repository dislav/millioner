...
const LostScreen: React.FC<PropsFromRedux> = ({ questions, clearQuestions }) => {
    ...
    return (
        <Container>
            ...
            <Text>
                ...
                Вы верно ответили на {questions.answered} вопросов и вас счет составлял {questions.score} ₽
            </Text>
...
export default connector(LostScreen);
